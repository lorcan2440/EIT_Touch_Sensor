...
def main():
    ...
    # setup equipment
    ross = RectEIT()
    ross._OUTPUT_FILE = 'output/EIT_Data_Gelatin_2_fingers_4_dof - SD.xlsx'
    ...
    ross.get_randomised_data(num_trials=500, baseline=True,
                             take_baseline_every=10, num_fingers=2)
